# Comparing `tmp/BindingGP-0.0.35.tar.gz` & `tmp/BindingGP-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "BindingGP-0.0.35.tar", last modified: Wed Apr 26 13:46:10 2023, max compression
+gzip compressed data, was "dist\BindingGP-0.0.9.tar", last modified: Sat Sep 26 02:35:38 2020, max compression
```

## Comparing `BindingGP-0.0.35.tar` & `BindingGP-0.0.9.tar`

### file list

```diff
@@ -1,53 +1,46 @@
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.216649 BindingGP-0.0.35/
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.185643 BindingGP-0.0.35/BindingGP.egg-info/
--rw-rw-rw-   0        0        0     2351 2023-04-26 13:46:09.000000 BindingGP-0.0.35/BindingGP.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      951 2023-04-26 13:46:10.000000 BindingGP-0.0.35/BindingGP.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-04-26 13:46:09.000000 BindingGP-0.0.35/BindingGP.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       88 2023-04-26 13:46:10.000000 BindingGP-0.0.35/BindingGP.egg-info/requires.txt
--rw-rw-rw-   0        0        0        4 2023-04-26 13:46:10.000000 BindingGP-0.0.35/BindingGP.egg-info/top_level.txt
--rw-rw-rw-   0        0        0     7797 2021-12-19 09:04:13.000000 BindingGP-0.0.35/LICENSE
--rw-rw-rw-   0        0        0       62 2021-12-19 09:04:13.000000 BindingGP-0.0.35/MANIFEST.in
--rw-rw-rw-   0        0        0     2351 2023-04-26 13:46:10.215652 BindingGP-0.0.35/PKG-INFO
--rw-rw-rw-   0        0        0     1314 2022-03-06 11:54:57.000000 BindingGP-0.0.35/README.md
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.191639 BindingGP-0.0.35/bgp/
--rw-rw-rw-   0        0        0      114 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/__init__.py
--rw-rw-rw-   0        0        0    59873 2022-09-28 13:42:27.000000 BindingGP-0.0.35/bgp/base.py
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.194589 BindingGP-0.0.35/bgp/calculation/
--rw-rw-rw-   0        0        0       52 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/calculation/__init__.py
--rw-rw-rw-   0        0        0    20718 2022-03-06 11:54:57.000000 BindingGP-0.0.35/bgp/calculation/coefficient.py
--rw-rw-rw-   0        0        0    20816 2023-04-26 10:53:33.000000 BindingGP-0.0.35/bgp/calculation/scores.py
--rw-rw-rw-   0        0        0     9504 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/calculation/translate.py
--rw-rw-rw-   0        0        0    26868 2023-04-26 13:18:35.000000 BindingGP-0.0.35/bgp/flow.py
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.200628 BindingGP-0.0.35/bgp/functions/
--rw-rw-rw-   0        0        0      519 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/functions/__init__.py
--rw-rw-rw-   0        0        0    17247 2022-08-13 08:39:55.000000 BindingGP-0.0.35/bgp/functions/dimfunc.py
--rw-rw-rw-   0        0        0     7247 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/functions/gsymfunc.py
--rw-rw-rw-   0        0        0     5024 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/functions/newfunc.py
--rw-rw-rw-   0        0        0     1705 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/functions/npfunc.py
--rw-rw-rw-   0        0        0     1562 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/functions/symfunc.py
--rw-rw-rw-   0        0        0    24106 2022-08-24 14:23:25.000000 BindingGP-0.0.35/bgp/gp.py
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.202645 BindingGP-0.0.35/bgp/iteration/
--rw-rw-rw-   0        0        0       40 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/iteration/__init__.py
--rw-rw-rw-   0        0        0     2563 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/iteration/newpoints.py
--rw-rw-rw-   0        0        0      159 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/iteration/nonewpoints.py
--rw-rw-rw-   0        0        0    17758 2023-04-26 13:45:06.000000 BindingGP-0.0.35/bgp/postprocess.py
--rw-rw-rw-   0        0        0     5267 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/preprocess.py
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.204625 BindingGP-0.0.35/bgp/probability/
--rw-rw-rw-   0        0        0       26 2021-12-19 09:04:13.000000 BindingGP-0.0.35/bgp/probability/__init__.py
--rw-rw-rw-   0        0        0    12258 2022-08-13 08:12:58.000000 BindingGP-0.0.35/bgp/probability/preference.py
--rw-rw-rw-   0        0        0    14294 2023-04-26 11:12:03.000000 BindingGP-0.0.35/bgp/skflow.py
--rw-rw-rw-   0        0        0      377 2021-12-19 09:04:13.000000 BindingGP-0.0.35/requirements.txt
--rw-rw-rw-   0        0        0       42 2023-04-26 13:46:10.216649 BindingGP-0.0.35/setup.cfg
--rw-rw-rw-   0        0        0     1906 2023-04-26 13:46:09.000000 BindingGP-0.0.35/setup.py
-drwxrwxrwx   0        0        0        0 2023-04-26 13:46:10.214646 BindingGP-0.0.35/test/
--rw-rw-rw-   0        0        0     2186 2023-04-26 13:39:56.000000 BindingGP-0.0.35/test/test2.py
--rw-rw-rw-   0        0        0     3712 2022-08-13 07:57:08.000000 BindingGP-0.0.35/test/test_der.py
--rw-rw-rw-   0        0        0    11183 2021-12-19 09:04:13.000000 BindingGP-0.0.35/test/test_dim.py
--rw-rw-rw-   0        0        0     5561 2021-12-19 09:04:13.000000 BindingGP-0.0.35/test/test_function.py
--rw-rw-rw-   0        0        0     2575 2022-08-13 08:36:17.000000 BindingGP-0.0.35/test/test_one_sample.py
--rw-rw-rw-   0        0        0      547 2021-12-19 09:04:13.000000 BindingGP-0.0.35/test/test_preference.py
--rw-rw-rw-   0        0        0     2948 2022-08-13 08:44:54.000000 BindingGP-0.0.35/test/test_score.py
--rw-rw-rw-   0        0        0     1318 2022-08-13 08:12:58.000000 BindingGP-0.0.35/test/test_simp.py
--rw-rw-rw-   0        0        0     3107 2022-08-13 08:12:59.000000 BindingGP-0.0.35/test/test_symbol_base.py
--rw-rw-rw-   0        0        0     3822 2022-08-13 08:12:59.000000 BindingGP-0.0.35/test/test_symbol_gp.py
--rw-rw-rw-   0        0        0     2529 2022-08-13 08:46:11.000000 BindingGP-0.0.35/test/test_translate.py
...
### Comparing `BindingGP-0.0.35/LICENSE` & `BindingGP-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `BindingGP-0.0.35/README.md` & `BindingGP-0.0.9/README.md`
...
### Comparing `BindingGP-0.0.35/bgp/base.py` & `BindingGP-0.0.9/BGP/base.py`
...
### Comparing `BindingGP-0.0.35/bgp/calculation/coefficient.py` & `BindingGP-0.0.9/BGP/calculation/coefficient.py`
...
### Comparing `BindingGP-0.0.35/bgp/calculation/scores.py` & `BindingGP-0.0.9/BGP/calculation/scores.py`
...
### Comparing `BindingGP-0.0.35/bgp/calculation/translate.py` & `BindingGP-0.0.9/BGP/calculation/translate.py`
...
### Comparing `BindingGP-0.0.35/bgp/flow.py` & `BindingGP-0.0.9/BGP/flow.py`
...
### Comparing `BindingGP-0.0.35/bgp/functions/__init__.py` & `BindingGP-0.0.9/BGP/functions/__init__.py`

 * *Files identical despite different names*

### Comparing `BindingGP-0.0.35/bgp/functions/dimfunc.py` & `BindingGP-0.0.9/BGP/functions/dimfunc.py`
...
### Comparing `BindingGP-0.0.35/bgp/functions/gsymfunc.py` & `BindingGP-0.0.9/BGP/functions/gsymfunc.py`
...
### Comparing `BindingGP-0.0.35/bgp/functions/newfunc.py` & `BindingGP-0.0.9/BGP/functions/newfunc.py`
...
### Comparing `BindingGP-0.0.35/bgp/functions/symfunc.py` & `BindingGP-0.0.9/BGP/functions/symfunc.py`
...
### Comparing `BindingGP-0.0.35/bgp/gp.py` & `BindingGP-0.0.9/BGP/gp.py`
...
### Comparing `BindingGP-0.0.35/bgp/preprocess.py` & `BindingGP-0.0.9/BGP/preprocess.py`
...
### Comparing `BindingGP-0.0.35/bgp/probability/preference.py` & `BindingGP-0.0.9/BGP/probability/preference.py`
...
### Comparing `BindingGP-0.0.35/bgp/skflow.py` & `BindingGP-0.0.9/BGP/skflow.py`
...
### Comparing `BindingGP-0.0.35/setup.py` & `BindingGP-0.0.9/setup.py`
...
### Comparing `BindingGP-0.0.35/test/test2.py` & `BindingGP-0.0.9/test/test_score.py`
...
### Comparing `BindingGP-0.0.35/test/test_dim.py` & `BindingGP-0.0.9/test/test_dim.py`
...
### Comparing `BindingGP-0.0.35/test/test_function.py` & `BindingGP-0.0.9/test/test_function.py`
...
### Comparing `BindingGP-0.0.35/test/test_preference.py` & `BindingGP-0.0.9/test/test_preference.py`
...
### Comparing `BindingGP-0.0.35/test/test_score.py` & `BindingGP-0.0.9/test/test_translate.py`
...
### Comparing `BindingGP-0.0.35/test/test_simp.py` & `BindingGP-0.0.9/test/test_simp.py`
...
### Comparing `BindingGP-0.0.35/test/test_symbol_base.py` & `BindingGP-0.0.9/test/test_symbol_base.py`
...
### Comparing `BindingGP-0.0.35/test/test_symbol_gp.py` & `BindingGP-0.0.9/test/test_symbol_gp.py`
