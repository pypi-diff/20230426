# Comparing `tmp/cohere-4.2.0.tar.gz` & `tmp/cohere-4.2.1.tar.gz`
...
### Comparing `cohere-4.2.0/cohere/client.py` & `cohere-4.2.1/cohere/client.py`
...
### Comparing `cohere-4.2.0/setup.py` & `cohere-4.2.1/setup.py`
