# Comparing `tmp/chesstab-7.0.tar.gz` & `tmp/chesstab-7.0.1.tar.gz`
...
### Comparing `chesstab-7.0/LICENCE` & `chesstab-7.0.1/LICENCE`
...
### Comparing `chesstab-7.0/chesstab/core/engine.py` & `chesstab-7.0.1/chesstab/core/engine.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/export_chessql.py` & `chesstab-7.0.1/chesstab/core/export_chessql.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/export_game.py` & `chesstab-7.0.1/chesstab/core/export_game.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/export_pgn_import_format.py` & `chesstab-7.0.1/chesstab/core/export_pgn_import_format.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/export_repertoire.py` & `chesstab-7.0.1/chesstab/core/export_repertoire.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/export_selection_rule.py` & `chesstab-7.0.1/chesstab/core/export_selection_rule.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/filespec.py` & `chesstab-7.0.1/chesstab/core/filespec.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/pgn.py` & `chesstab-7.0.1/chesstab/core/pgn.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/querystatement.py` & `chesstab-7.0.1/chesstab/core/querystatement.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/uci.py` & `chesstab-7.0.1/chesstab/core/uci.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/core/uci_to_pgn.py` & `chesstab-7.0.1/chesstab/core/uci_to_pgn.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/db/chessdb.py` & `chesstab-7.0.1/chesstab/db/chessdb.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/db/chessdbdu.py` & `chesstab-7.0.1/chesstab/db/chessdbdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/db/runchessdbdu.py` & `chesstab-7.0.1/chesstab/db/runchessdbdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/db_tkinter/chessdbtkinter.py` & `chesstab-7.0.1/chesstab/db_tkinter/chessdbtkinter.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/db_tkinter/chessdbtkinterdu.py` & `chesstab-7.0.1/chesstab/db_tkinter/chessdbtkinterdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/db_tkinter/runchessdbtkinterdu.py` & `chesstab-7.0.1/chesstab/db_tkinter/runchessdbtkinterdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/__init__.py` & `chesstab-7.0.1/chesstab/dpt/__init__.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/analysisds.py` & `chesstab-7.0.1/chesstab/dpt/analysisds.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/chessdpt.py` & `chesstab-7.0.1/chesstab/dpt/chessdpt.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/chessdptdu.py` & `chesstab-7.0.1/chesstab/dpt/chessdptdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/cqlds.py` & `chesstab-7.0.1/chesstab/dpt/cqlds.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/fullpositionds.py` & `chesstab-7.0.1/chesstab/dpt/fullpositionds.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/runchessdptdu.py` & `chesstab-7.0.1/chesstab/dpt/runchessdptdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/runchessdptduchunk.py` & `chesstab-7.0.1/chesstab/dpt/runchessdptduchunk.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/dpt/selectionds.py` & `chesstab-7.0.1/chesstab/dpt/selectionds.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/CASEFONT.TTF` & `chesstab-7.0.1/chesstab/fonts/CASEFONT.TTF`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/LUCEFONT.TTF` & `chesstab-7.0.1/chesstab/fonts/LUCEFONT.TTF`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/MERIFONT.TTF` & `chesstab-7.0.1/chesstab/fonts/MERIFONT.TTF`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/MOTIFONT.TTF` & `chesstab-7.0.1/chesstab/fonts/MOTIFONT.TTF`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/cases.zip` & `chesstab-7.0.1/chesstab/fonts/cases.zip`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/lucen.zip` & `chesstab-7.0.1/chesstab/fonts/lucen.zip`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/merid.zip` & `chesstab-7.0.1/chesstab/fonts/merid.zip`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/fonts/motif.zip` & `chesstab-7.0.1/chesstab/fonts/motif.zip`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gnu/chessgnu.py` & `chesstab-7.0.1/chesstab/gnu/chessgnu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gnu/chessgnudu.py` & `chesstab-7.0.1/chesstab/gnu/chessgnudu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gnu/runchessgnudu.py` & `chesstab-7.0.1/chesstab/gnu/runchessgnudu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/__init__.py` & `chesstab-7.0.1/chesstab/gui/__init__.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/_lead_trail.py` & `chesstab-7.0.1/chesstab/gui/_lead_trail.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/_score_scaffold.py` & `chesstab-7.0.1/chesstab/gui/_score_scaffold.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/analysisscore.py` & `chesstab-7.0.1/chesstab/gui/analysisscore.py`
...
### Comparing `chesstab-7.0/chesstab/gui/blanktext.py` & `chesstab-7.0.1/chesstab/gui/blanktext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/board.py` & `chesstab-7.0.1/chesstab/gui/board.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/chess.py` & `chesstab-7.0.1/chesstab/gui/chess.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/chess_ui.py` & `chesstab-7.0.1/chesstab/gui/chess_ui.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/chessdu.py` & `chesstab-7.0.1/chesstab/gui/chessdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/colourscheme.py` & `chesstab-7.0.1/chesstab/gui/colourscheme.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/constants.py` & `chesstab-7.0.1/chesstab/gui/constants.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cql.py` & `chesstab-7.0.1/chesstab/gui/cql.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqldbdelete.py` & `chesstab-7.0.1/chesstab/gui/cqldbdelete.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqldbedit.py` & `chesstab-7.0.1/chesstab/gui/cqldbedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqldbshow.py` & `chesstab-7.0.1/chesstab/gui/cqldbshow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqldisplay.py` & `chesstab-7.0.1/chesstab/gui/cqldisplay.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqledit.py` & `chesstab-7.0.1/chesstab/gui/cqledit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqlgrid.py` & `chesstab-7.0.1/chesstab/gui/cqlgrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqlrow.py` & `chesstab-7.0.1/chesstab/gui/cqlrow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqltext.py` & `chesstab-7.0.1/chesstab/gui/cqltext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/cqltoplevel.py` & `chesstab-7.0.1/chesstab/gui/cqltoplevel.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/display.py` & `chesstab-7.0.1/chesstab/gui/display.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/displayitems.py` & `chesstab-7.0.1/chesstab/gui/displayitems.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/displaypgn.py` & `chesstab-7.0.1/chesstab/gui/displaypgn.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/displaytext.py` & `chesstab-7.0.1/chesstab/gui/displaytext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/engine.py` & `chesstab-7.0.1/chesstab/gui/engine.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginedbdelete.py` & `chesstab-7.0.1/chesstab/gui/enginedbdelete.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginedbedit.py` & `chesstab-7.0.1/chesstab/gui/enginedbedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginedbshow.py` & `chesstab-7.0.1/chesstab/gui/enginedbshow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/engineedit.py` & `chesstab-7.0.1/chesstab/gui/engineedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginegrid.py` & `chesstab-7.0.1/chesstab/gui/enginegrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginerow.py` & `chesstab-7.0.1/chesstab/gui/enginerow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginetext.py` & `chesstab-7.0.1/chesstab/gui/enginetext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/enginetoplevel.py` & `chesstab-7.0.1/chesstab/gui/enginetoplevel.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/eventbinding.py` & `chesstab-7.0.1/chesstab/gui/eventbinding.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/eventspec.py` & `chesstab-7.0.1/chesstab/gui/eventspec.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/fonts.py` & `chesstab-7.0.1/chesstab/gui/fonts.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/game.py` & `chesstab-7.0.1/chesstab/gui/game.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gamedbdelete.py` & `chesstab-7.0.1/chesstab/gui/gamedbdelete.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gamedbedit.py` & `chesstab-7.0.1/chesstab/gui/gamedbedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gamedbshow.py` & `chesstab-7.0.1/chesstab/gui/gamedbshow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gamedisplay.py` & `chesstab-7.0.1/chesstab/gui/gamedisplay.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gameedit.py` & `chesstab-7.0.1/chesstab/gui/gameedit.py`
...
### Comparing `chesstab-7.0/chesstab/gui/gamegrid.py` & `chesstab-7.0.1/chesstab/gui/gamegrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gamelistgrid.py` & `chesstab-7.0.1/chesstab/gui/gamelistgrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gamerow.py` & `chesstab-7.0.1/chesstab/gui/gamerow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/gametoplevel.py` & `chesstab-7.0.1/chesstab/gui/gametoplevel.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/help_.py` & `chesstab-7.0.1/chesstab/gui/help_.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/options.py` & `chesstab-7.0.1/chesstab/gui/options.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/positionrow.py` & `chesstab-7.0.1/chesstab/gui/positionrow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/positionscore.py` & `chesstab-7.0.1/chesstab/gui/positionscore.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/query.py` & `chesstab-7.0.1/chesstab/gui/query.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querydbdelete.py` & `chesstab-7.0.1/chesstab/gui/querydbdelete.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querydbedit.py` & `chesstab-7.0.1/chesstab/gui/querydbedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querydbshow.py` & `chesstab-7.0.1/chesstab/gui/querydbshow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querydisplay.py` & `chesstab-7.0.1/chesstab/gui/querydisplay.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/queryedit.py` & `chesstab-7.0.1/chesstab/gui/queryedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querygrid.py` & `chesstab-7.0.1/chesstab/gui/querygrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/queryrow.py` & `chesstab-7.0.1/chesstab/gui/queryrow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querytext.py` & `chesstab-7.0.1/chesstab/gui/querytext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/querytoplevel.py` & `chesstab-7.0.1/chesstab/gui/querytoplevel.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoire.py` & `chesstab-7.0.1/chesstab/gui/repertoire.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoiredbdelete.py` & `chesstab-7.0.1/chesstab/gui/repertoiredbdelete.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoiredbedit.py` & `chesstab-7.0.1/chesstab/gui/repertoiredbedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoiredbshow.py` & `chesstab-7.0.1/chesstab/gui/repertoiredbshow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoiredisplay.py` & `chesstab-7.0.1/chesstab/gui/repertoiredisplay.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoireedit.py` & `chesstab-7.0.1/chesstab/gui/repertoireedit.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoiregrid.py` & `chesstab-7.0.1/chesstab/gui/repertoiregrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoirerow.py` & `chesstab-7.0.1/chesstab/gui/repertoirerow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/repertoiretoplevel.py` & `chesstab-7.0.1/chesstab/gui/repertoiretoplevel.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/score.py` & `chesstab-7.0.1/chesstab/gui/score.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/scorepgn.py` & `chesstab-7.0.1/chesstab/gui/scorepgn.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/sharedtext.py` & `chesstab-7.0.1/chesstab/gui/sharedtext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/toplevelpgn.py` & `chesstab-7.0.1/chesstab/gui/toplevelpgn.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/topleveltext.py` & `chesstab-7.0.1/chesstab/gui/topleveltext.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/gui/uci.py` & `chesstab-7.0.1/chesstab/gui/uci.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/help_/__init__.py` & `chesstab-7.0.1/chesstab/help_/__init__.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/help_/aboutchesstab.rst` & `chesstab-7.0.1/chesstab/help_/aboutchesstab.rst`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/help_/chesstab.rst` & `chesstab-7.0.1/chesstab/help_/chesstab.rst`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/help_/filesize.rst` & `chesstab-7.0.1/chesstab/help_/filesize.rst`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/help_/guide.rst` & `chesstab-7.0.1/chesstab/help_/guide.rst`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/help_/selection.rst` & `chesstab-7.0.1/chesstab/help_/selection.rst`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/lmdb/chesslmdb.py` & `chesstab-7.0.1/chesstab/lmdb/chesslmdb.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/lmdb/chesslmdbdu.py` & `chesstab-7.0.1/chesstab/lmdb/chesslmdbdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/lmdb/runchesslmdbdu.py` & `chesstab-7.0.1/chesstab/lmdb/runchesslmdbdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/ndbm/chessndbm.py` & `chesstab-7.0.1/chesstab/ndbm/chessndbm.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/ndbm/chessndbmdu.py` & `chesstab-7.0.1/chesstab/ndbm/chessndbmdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/ndbm/runchessndbmdu.py` & `chesstab-7.0.1/chesstab/ndbm/runchessndbmdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/chessboard.py` & `chesstab-7.0.1/chesstab/samples/chessboard.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/chessgame.py` & `chesstab-7.0.1/chesstab/samples/chessgame.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/chessscore.py` & `chesstab-7.0.1/chesstab/samples/chessscore.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/chessscoreboard.py` & `chesstab-7.0.1/chesstab/samples/chessscoreboard.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/directory_widget.py` & `chesstab-7.0.1/chesstab/samples/directory_widget.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/dptdu_file.py` & `chesstab-7.0.1/chesstab/samples/dptdu_file.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/dptduchunk.py` & `chesstab-7.0.1/chesstab/samples/dptduchunk.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/dptdumulti.py` & `chesstab-7.0.1/chesstab/samples/dptdumulti.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/file_widget.py` & `chesstab-7.0.1/chesstab/samples/file_widget.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/ndbmdu_dir.py` & `chesstab-7.0.1/chesstab/samples/ndbmdu_dir.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/read_pgn_profile.py` & `chesstab-7.0.1/chesstab/samples/read_pgn_profile.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/update_players_sqlite3.py` & `chesstab-7.0.1/chesstab/samples/update_players_sqlite3.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/view_players_bsddb3.py` & `chesstab-7.0.1/chesstab/samples/view_players_bsddb3.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/samples/view_raw_records_bsddb3.py` & `chesstab-7.0.1/chesstab/samples/view_raw_records_bsddb3.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/alldu.py` & `chesstab-7.0.1/chesstab/shared/alldu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/allgrid.py` & `chesstab-7.0.1/chesstab/shared/allgrid.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/allrow.py` & `chesstab-7.0.1/chesstab/shared/allrow.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/archivedu.py` & `chesstab-7.0.1/chesstab/shared/archivedu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/cql_gamelist_query.py` & `chesstab-7.0.1/chesstab/shared/cql_gamelist_query.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/dbdu.py` & `chesstab-7.0.1/chesstab/shared/dbdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/dbdutcl.py` & `chesstab-7.0.1/chesstab/shared/dbdutcl.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/dptcompatdu.py` & `chesstab-7.0.1/chesstab/shared/dptcompatdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/game_position.py` & `chesstab-7.0.1/chesstab/shared/game_position.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/litedu.py` & `chesstab-7.0.1/chesstab/shared/litedu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/lmdbdu.py` & `chesstab-7.0.1/chesstab/shared/lmdbdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/shared/rundu.py` & `chesstab-7.0.1/chesstab/shared/rundu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/sqlite/chesssqlite3.py` & `chesstab-7.0.1/chesstab/sqlite/chesssqlite3.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/sqlite/chesssqlite3du.py` & `chesstab-7.0.1/chesstab/sqlite/chesssqlite3du.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/sqlite/runchesssqlite3du.py` & `chesstab-7.0.1/chesstab/sqlite/runchesssqlite3du.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/tools/berkeleydb_du_splice_fix.py` & `chesstab-7.0.1/chesstab/tools/berkeleydb_du_splice_fix.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/tools/chesstab-4-1-1_castling-option-correction.py` & `chesstab-7.0.1/chesstab/tools/chesstab-4-1-1_castling-option-correction.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/tools/create_chesstab_database.py` & `chesstab-7.0.1/chesstab/tools/create_chesstab_database.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/unqlite/chessunqlite.py` & `chesstab-7.0.1/chesstab/unqlite/chessunqlite.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/unqlite/chessunqlitedu.py` & `chesstab-7.0.1/chesstab/unqlite/chessunqlitedu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/unqlite/runchessunqlitedu.py` & `chesstab-7.0.1/chesstab/unqlite/runchessunqlitedu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/vedis/chessvedis.py` & `chesstab-7.0.1/chesstab/vedis/chessvedis.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/vedis/chessvedisdu.py` & `chesstab-7.0.1/chesstab/vedis/chessvedisdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab/vedis/runchessvedisdu.py` & `chesstab-7.0.1/chesstab/vedis/runchessvedisdu.py`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/chesstab.egg-info/PKG-INFO` & `chesstab-7.0.1/chesstab.egg-info/PKG-INFO`
...
### Comparing `chesstab-7.0/chesstab.egg-info/SOURCES.txt` & `chesstab-7.0.1/chesstab.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `chesstab-7.0/setup.cfg` & `chesstab-7.0.1/setup.cfg`
...
### Comparing `chesstab-7.0/setup.py` & `chesstab-7.0.1/setup.py`
