# Comparing `tmp/catppuccin-1.1.1.tar.gz` & `tmp/catppuccin-1.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "catppuccin-1.1.1.tar", max compression
+gzip compressed data, was "catppuccin-1.2.0.tar", max compression
```

## Comparing `catppuccin-1.1.1.tar` & `catppuccin-1.2.0.tar`

### file list

```diff
@@ -1,10 +1,10 @@
--rw-r--r--   0        0        0     1067 2022-11-17 21:20:54.018646 catppuccin-1.1.1/LICENSE
--rw-r--r--   0        0        0     3975 2022-11-17 21:20:54.018646 catppuccin-1.1.1/README.md
--rw-r--r--   0        0        0      142 2022-11-17 21:20:54.018646 catppuccin-1.1.1/catppuccin/__init__.py
--rw-r--r--   0        0        0      593 2022-11-17 21:20:54.018646 catppuccin-1.1.1/catppuccin/colour.py
--rw-r--r--   0        0        0        0 2022-11-17 21:20:54.018646 catppuccin-1.1.1/catppuccin/extras/__init__.py
--rw-r--r--   0        0        0     2138 2022-11-17 21:20:54.018646 catppuccin-1.1.1/catppuccin/extras/pygments.py
--rw-r--r--   0        0        0     5641 2022-11-17 21:20:54.018646 catppuccin-1.1.1/catppuccin/flavour.py
--rw-r--r--   0        0        0     1129 2022-11-17 21:21:40.334584 catppuccin-1.1.1/pyproject.toml
--rw-r--r--   0        0        0     5248 1970-01-01 00:00:00.000000 catppuccin-1.1.1/setup.py
--rw-r--r--   0        0        0     4545 1970-01-01 00:00:00.000000 catppuccin-1.1.1/PKG-INFO
...
### Comparing `catppuccin-1.1.1/LICENSE` & `catppuccin-1.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `catppuccin-1.1.1/README.md` & `catppuccin-1.2.0/README.md`

 * *Files identical despite different names*

### Comparing `catppuccin-1.1.1/catppuccin/extras/pygments.py` & `catppuccin-1.2.0/catppuccin/extras/pygments.py`

 * *Files identical despite different names*

### Comparing `catppuccin-1.1.1/catppuccin/flavour.py` & `catppuccin-1.2.0/catppuccin/flavour.py`

 * *Files identical despite different names*

### Comparing `catppuccin-1.1.1/pyproject.toml` & `catppuccin-1.2.0/pyproject.toml`
...
### Comparing `catppuccin-1.1.1/setup.py` & `catppuccin-1.2.0/setup.py`
...
-{ 'name': 'catppuccin', 'version': '1.1.1', 'description': 'ð Soothing
...
### Comparing `catppuccin-1.1.1/PKG-INFO` & `catppuccin-1.2.0/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: catppuccin Version: 1.1.1 Summary: ð Soothing
