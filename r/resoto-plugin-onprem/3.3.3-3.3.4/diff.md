# Comparing `tmp/resoto-plugin-onprem-3.3.3.tar.gz` & `tmp/resoto-plugin-onprem-3.3.4.tar.gz`
...
## Comparing `resoto-plugin-onprem-3.3.3.tar` & `resoto-plugin-onprem-3.3.4.tar`
...
### Comparing `resoto-plugin-onprem-3.3.3/PKG-INFO` & `resoto-plugin-onprem-3.3.4/PKG-INFO`
...
### Comparing `resoto-plugin-onprem-3.3.3/resoto_plugin_onprem/__init__.py` & `resoto-plugin-onprem-3.3.4/resoto_plugin_onprem/__init__.py`

 * *Files identical despite different names*

### Comparing `resoto-plugin-onprem-3.3.3/resoto_plugin_onprem/config.py` & `resoto-plugin-onprem-3.3.4/resoto_plugin_onprem/config.py`

 * *Files identical despite different names*

### Comparing `resoto-plugin-onprem-3.3.3/resoto_plugin_onprem/resources.py` & `resoto-plugin-onprem-3.3.4/resoto_plugin_onprem/resources.py`

 * *Files identical despite different names*

### Comparing `resoto-plugin-onprem-3.3.3/resoto_plugin_onprem/ssh.py` & `resoto-plugin-onprem-3.3.4/resoto_plugin_onprem/ssh.py`

 * *Files identical despite different names*

### Comparing `resoto-plugin-onprem-3.3.3/resoto_plugin_onprem.egg-info/PKG-INFO` & `resoto-plugin-onprem-3.3.4/resoto_plugin_onprem.egg-info/PKG-INFO`
...
### Comparing `resoto-plugin-onprem-3.3.3/resoto_plugin_onprem.egg-info/SOURCES.txt` & `resoto-plugin-onprem-3.3.4/resoto_plugin_onprem.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `resoto-plugin-onprem-3.3.3/setup.py` & `resoto-plugin-onprem-3.3.4/setup.py`
...
### Comparing `resoto-plugin-onprem-3.3.3/test/test_config.py` & `resoto-plugin-onprem-3.3.4/test/test_config.py`
