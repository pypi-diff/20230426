# Comparing `tmp/airbyte-1.4.0.tar.gz` & `tmp/airbyte-1.5.0.tar.gz`
...
### Comparing `airbyte-1.4.0/LICENSE.md` & `airbyte-1.5.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/PKG-INFO` & `airbyte-1.5.0/PKG-INFO`
...
-* `delete_connection` - Get Connection details
-* `get_connection` - Get Connection details
-* `list_connections` - List connections
+* [create_connection](docs/connections/README.md#create_connection) - Create a connection
+* [delete_connection](docs/connections/README.md#delete_connection) - Get Connection details
...
-* `delete_destination` - Get Connection details
...
+* [delete_destination](docs/destinations/README.md#delete_destination) - Get Connection details
...
-* `delete_source` - Get Connection details
-* `get_source` - Get Source details
-* `list_sources` - List sources
+* [create_source](docs/sources/README.md#create_source) - Create a source
+* [delete_source](docs/sources/README.md#delete_source) - Get Connection details
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: airbyte Version: 1.4.0 Summary: Python Client SDK
...
@@ -17,17 +17,17 @@
 Portal, use the API Keys tab to create or remove API Keys. You can see a
 walkthrough demo here ð¦ The Developer Portal UI can also be used to help
 build your integration by showing information about network requests in the
 Requests tab. API usage information is also available to you in the Usage tab.
 (Installation will not work until published to a package manager, please
 install locally to try it out `pip install -e ../path/to/local/clone`)  ## SDK
 Installation ```bash pip install airbyte ```  ## SDK Example Usage  ```python
-import airbyte from airbyte.models import operations, shared s =
-airbyte.Airbyte( security=shared.Security( bearer_auth="Bearer
-YOUR_BEARER_TOKEN_HERE", ), ) req = shared.ConnectionCreateRequest
+import airbyte from airbyte.models import shared s = airbyte.Airbyte
+( security=shared.Security( bearer_auth="Bearer YOUR_BEARER_TOKEN_HERE", ), )
...
-connection * `delete_connection` - Get Connection details * `get_connection` -
-Get Connection details * `list_connections` - List connections ### destinations
-* `create_destination` - Create a destination * `delete_destination` - Get
-Connection details * `get_destination` - Get Destination details *
-`list_destinations` - List destinations ### jobs * `cancel_job` - Cancel a
-running Job * `create_job` - Trigger a sync or reset job of a connection *
-`get_job` - Get Job status and details * `list_jobs` - List Jobs by sync type
-### sources * `create_source` - Create a source * `delete_source` - Get
-Connection details * `get_source` - Get Source details * `list_sources` - List
-sources ### streams * `get_stream_properties` - Get stream properties ###
-workspaces * `create_workspace` - Create a workspace * `get_workspace` - Get
-Workspace details * `list_workspaces` - List workspaces  ### SDK Generated by
-[Speakeasy](https://docs.speakeasyapi.dev/docs/using-speakeasy/client-sdks)
...
+- Get Connection details * [get_connection](docs/connections/
...
+(docs/destinations/README.md#delete_destination) - Get Connection details *
...
+README.md#delete_source) - Get Connection details * [get_source](docs/sources/
+README.md#get_source) - Get Source details * [list_sources](docs/sources/
+README.md#list_sources) - List sources ### [streams](docs/streams/README.md) *
+[get_stream_properties](docs/streams/README.md#get_stream_properties) - Get
+stream properties ### [workspaces](docs/workspaces/README.md) *
...
+README.md#list_workspaces) - List workspaces  ### SDK Generated by [Speakeasy]
+(https://docs.speakeasyapi.dev/docs/using-speakeasy/client-sdks)
```

### Comparing `airbyte-1.4.0/README.md` & `airbyte-1.5.0/README.md`
...
### Comparing `airbyte-1.4.0/setup.py` & `airbyte-1.5.0/setup.py`
...
### Comparing `airbyte-1.4.0/src/airbyte/connections.py` & `airbyte-1.5.0/src/airbyte/connections.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/destinations.py` & `airbyte-1.5.0/src/airbyte/destinations.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/jobs.py` & `airbyte-1.5.0/src/airbyte/jobs.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/__init__.py` & `airbyte-1.5.0/src/airbyte/models/operations/__init__.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/canceljob.py` & `airbyte-1.5.0/src/airbyte/models/operations/canceljob.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/createconnection.py` & `airbyte-1.5.0/src/airbyte/models/operations/createconnection.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/createdestination.py` & `airbyte-1.5.0/src/airbyte/models/operations/createdestination.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/createjob.py` & `airbyte-1.5.0/src/airbyte/models/operations/createjob.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/createsource.py` & `airbyte-1.5.0/src/airbyte/models/operations/createsource.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/createworkspace.py` & `airbyte-1.5.0/src/airbyte/models/operations/createworkspace.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/deleteconnection.py` & `airbyte-1.5.0/src/airbyte/models/operations/deleteconnection.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/deletedestination.py` & `airbyte-1.5.0/src/airbyte/models/operations/deletedestination.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/deletesource.py` & `airbyte-1.5.0/src/airbyte/models/operations/deletesource.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/getconnection.py` & `airbyte-1.5.0/src/airbyte/models/operations/getconnection.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/getdestination.py` & `airbyte-1.5.0/src/airbyte/models/operations/getdestination.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/getjob.py` & `airbyte-1.5.0/src/airbyte/models/operations/getjob.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/getsource.py` & `airbyte-1.5.0/src/airbyte/models/operations/getsource.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/getstreamproperties.py` & `airbyte-1.5.0/src/airbyte/models/operations/getstreamproperties.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/getworkspace.py` & `airbyte-1.5.0/src/airbyte/models/operations/getworkspace.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/listconnections.py` & `airbyte-1.5.0/src/airbyte/models/operations/listconnections.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/listdestinations.py` & `airbyte-1.5.0/src/airbyte/models/operations/listdestinations.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/listjobs.py` & `airbyte-1.5.0/src/airbyte/models/operations/listjobs.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/listsources.py` & `airbyte-1.5.0/src/airbyte/models/operations/listsources.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/operations/listworkspaces.py` & `airbyte-1.5.0/src/airbyte/models/operations/listworkspaces.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/__init__.py` & `airbyte-1.5.0/src/airbyte/models/shared/__init__.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/connectioncreaterequest.py` & `airbyte-1.5.0/src/airbyte/models/shared/connectioncreaterequest.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/connectionresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/connectionresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/connectionschedulecreate.py` & `airbyte-1.5.0/src/airbyte/models/shared/connectionschedulecreate.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/connectionscheduleresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/connectionscheduleresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/connectionsresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/connectionsresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_amazon_sqs.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_amazon_sqs.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_aws_datalake.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_aws_datalake.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_azure_blob_storage.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_azure_blob_storage.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_bigquery.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_bigquery.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_bigquery_denormalized.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_bigquery_denormalized.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_cassandra.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_cassandra.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_clickhouse.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_clickhouse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_convex.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_convex.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_databend.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_databend.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_databricks.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_databricks.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_dynamodb.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_dynamodb.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_elasticsearch.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_elasticsearch.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_firebolt.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_firebolt.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_firestore.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_firestore.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_gcs.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_gcs.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_google_sheets.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_google_sheets.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_keen.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_keen.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_kinesis.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_kinesis.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_mariadb_columnstore.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_mariadb_columnstore.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_meilisearch.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_meilisearch.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_mongodb.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_mongodb.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_mssql.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_mssql.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_mysql.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_mysql.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_oracle.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_oracle.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_postgres.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_postgres.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_pubsub.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_pubsub.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_pulsar.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_pulsar.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_rabbitmq.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_rabbitmq.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_redis.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_redis.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_redshift.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_redshift.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_rockset.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_rockset.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_s3.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_s3.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_s3_glue.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_s3_glue.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_scylla.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_scylla.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_sftp_json.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_sftp_json.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_snowflake.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_snowflake.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destination_typesense.py` & `airbyte-1.5.0/src/airbyte/models/shared/destination_typesense.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destinationcreaterequest.py` & `airbyte-1.5.0/src/airbyte/models/shared/destinationcreaterequest.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destinationresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/destinationresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/destinationsresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/destinationsresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/jobcreaterequest.py` & `airbyte-1.5.0/src/airbyte/models/shared/jobcreaterequest.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/jobresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/jobresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/jobsresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/jobsresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_airtable.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_airtable.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_alloydb.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_alloydb.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_amazon_ads.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_amazon_ads.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_amazon_seller_partner.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_amazon_seller_partner.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_amazon_sqs.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_amazon_sqs.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_amplitude.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_amplitude.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_apify_dataset.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_apify_dataset.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_asana.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_asana.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_auth0.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_auth0.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_aws_cloudtrail.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_aws_cloudtrail.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_azure_blob_storage.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_azure_blob_storage.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_azure_table.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_azure_table.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_bamboo_hr.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_bamboo_hr.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_bigcommerce.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_bigcommerce.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_bigquery.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_bigquery.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_bing_ads.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_bing_ads.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_braintree.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_braintree.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_braze.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_braze.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_chargebee.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_chargebee.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_chartmogul.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_chartmogul.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_clickhouse.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_clickhouse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_clickup_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_clickup_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_close_com.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_close_com.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_coda.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_coda.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_coin_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_coin_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_coinmarketcap.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_coinmarketcap.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_configcat.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_configcat.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_confluence.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_confluence.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_datascope.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_datascope.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_delighted.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_delighted.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_dixa.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_dixa.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_dockerhub.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_dockerhub.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_dremio.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_dremio.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_dynamodb.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_dynamodb.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_e2e_test_cloud.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_e2e_test_cloud.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_emailoctopus.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_emailoctopus.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_exchange_rates.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_exchange_rates.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_facebook_marketing.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_facebook_marketing.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_facebook_pages.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_facebook_pages.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_faker.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_faker.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_fauna.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_fauna.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_file_secure.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_file_secure.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_firebolt.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_firebolt.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_freshcaller.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_freshcaller.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_freshdesk.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_freshdesk.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_freshsales.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_freshsales.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_gcs.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_gcs.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_getlago.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_getlago.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_github.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_github.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_gitlab.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_gitlab.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_glassfrog.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_glassfrog.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_gnews.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_gnews.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_ads.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_ads.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_analytics_data_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_analytics_data_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_analytics_v4.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_analytics_v4.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_directory.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_directory.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_search_console.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_search_console.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_sheets.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_sheets.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_webfonts.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_webfonts.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_google_workspace_admin_reports.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_google_workspace_admin_reports.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_greenhouse.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_greenhouse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_gridly.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_gridly.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_harvest.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_harvest.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_hubplanner.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_hubplanner.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_hubspot.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_hubspot.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_insightly.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_insightly.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_instagram.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_instagram.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_instatus.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_instatus.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_intercom.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_intercom.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_ip2whois.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_ip2whois.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_iterable.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_iterable.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_jira.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_jira.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_k6_cloud.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_k6_cloud.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_klarna.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_klarna.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_klaviyo.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_klaviyo.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_kustomer_singer.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_kustomer_singer.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_launchdarkly.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_launchdarkly.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_lemlist.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_lemlist.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_linkedin_ads.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_linkedin_ads.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_linkedin_pages.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_linkedin_pages.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_linnworks.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_linnworks.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_lokalise.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_lokalise.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mailchimp.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mailchimp.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mailgun.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mailgun.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mailjet_sms.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mailjet_sms.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_marketo.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_marketo.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_metabase.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_metabase.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_microsoft_teams.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_microsoft_teams.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mixpanel.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mixpanel.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_monday.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_monday.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mongodb.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mongodb.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mssql.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mssql.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_my_hours.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_my_hours.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_mysql.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_mysql.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_netsuite.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_netsuite.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_notion.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_notion.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_nytimes.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_nytimes.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_okta.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_okta.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_omnisend.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_omnisend.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_onesignal.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_onesignal.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_openweather.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_openweather.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_oracle.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_oracle.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_orb.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_orb.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_orbit.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_orbit.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_outreach.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_outreach.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_paypal_transaction.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_paypal_transaction.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_paystack.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_paystack.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pendo.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pendo.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_persistiq.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_persistiq.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pexels_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pexels_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pinterest.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pinterest.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pipedrive.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pipedrive.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pocket.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pocket.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pokeapi.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pokeapi.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_polygon_stock_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_polygon_stock_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_postgres.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_postgres.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_posthog.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_posthog.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_postmarkapp.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_postmarkapp.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_prestashop.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_prestashop.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_public_apis.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_public_apis.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_punk_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_punk_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_pypi.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_pypi.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_qualaroo.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_qualaroo.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_quickbooks.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_quickbooks.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_railz.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_railz.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_recharge.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_recharge.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_recreation.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_recreation.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_recruitee.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_recruitee.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_recurly.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_recurly.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_redshift.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_redshift.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_retently.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_retently.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_rki_covid.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_rki_covid.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_rss.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_rss.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_s3.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_s3.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_salesforce.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_salesforce.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_salesforce_singer.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_salesforce_singer.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_salesloft.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_salesloft.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sap_fieldglass.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sap_fieldglass.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_secoda.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_secoda.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sendgrid.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sendgrid.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sendinblue.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sendinblue.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_senseforce.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_senseforce.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sentry.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sentry.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sftp.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sftp.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sftp_bulk.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sftp_bulk.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_shopify.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_shopify.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_shortio.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_shortio.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_slack.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_slack.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_smaily.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_smaily.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_smartengage.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_smartengage.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_smartsheets.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_smartsheets.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_snapchat_marketing.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_snapchat_marketing.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_snowflake.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_snowflake.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_sonar_cloud.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_sonar_cloud.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_spacex_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_spacex_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_square.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_square.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_strava.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_strava.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_stripe.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_stripe.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_survey_sparrow.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_survey_sparrow.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_surveymonkey.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_surveymonkey.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_tempo.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_tempo.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_the_guardian_api.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_the_guardian_api.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_tiktok_marketing.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_tiktok_marketing.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_todoist.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_todoist.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_trello.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_trello.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_trustpilot.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_trustpilot.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_tvmaze_schedule.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_tvmaze_schedule.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_twilio.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_twilio.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_twilio_taskrouter.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_twilio_taskrouter.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_twitter.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_twitter.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_typeform.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_typeform.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_us_census.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_us_census.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_vantage.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_vantage.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_webflow.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_webflow.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_whisky_hunter.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_whisky_hunter.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_wikipedia_pageviews.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_wikipedia_pageviews.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_woocommerce.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_woocommerce.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_xero.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_xero.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_xkcd.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_xkcd.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_yandex_metrica.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_yandex_metrica.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_younium.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_younium.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_youtube_analytics.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_youtube_analytics.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zendesk_chat.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zendesk_chat.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zendesk_sunshine.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zendesk_sunshine.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zendesk_support.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zendesk_support.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zendesk_talk.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zendesk_talk.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zenloop.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zenloop.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zoho_crm.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zoho_crm.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zoom.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zoom.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/source_zuora.py` & `airbyte-1.5.0/src/airbyte/models/shared/source_zuora.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/sourcecreaterequest.py` & `airbyte-1.5.0/src/airbyte/models/shared/sourcecreaterequest.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/sourceresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/sourceresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/sourcesresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/sourcesresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/streamconfiguration.py` & `airbyte-1.5.0/src/airbyte/models/shared/streamconfiguration.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/streamconfigurations.py` & `airbyte-1.5.0/src/airbyte/models/shared/streamconfigurations.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/streamproperties.py` & `airbyte-1.5.0/src/airbyte/models/shared/streamproperties.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/workspaceresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/workspaceresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/models/shared/workspacesresponse.py` & `airbyte-1.5.0/src/airbyte/models/shared/workspacesresponse.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/sdk.py` & `airbyte-1.5.0/src/airbyte/sdk.py`
...
### Comparing `airbyte-1.4.0/src/airbyte/sources.py` & `airbyte-1.5.0/src/airbyte/sources.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/streams.py` & `airbyte-1.5.0/src/airbyte/streams.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/utils/retries.py` & `airbyte-1.5.0/src/airbyte/utils/retries.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/utils/utils.py` & `airbyte-1.5.0/src/airbyte/utils/utils.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte/workspaces.py` & `airbyte-1.5.0/src/airbyte/workspaces.py`

 * *Files identical despite different names*

### Comparing `airbyte-1.4.0/src/airbyte.egg-info/PKG-INFO` & `airbyte-1.5.0/src/airbyte.egg-info/PKG-INFO`
...
### Comparing `airbyte-1.4.0/src/airbyte.egg-info/SOURCES.txt` & `airbyte-1.5.0/src/airbyte.egg-info/SOURCES.txt`
