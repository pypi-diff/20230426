# Comparing `tmp/pe-configurator-0.1.2.tar.gz` & `tmp/pe-configurator-0.1.3.tar.gz`
...
## Comparing `pe-configurator-0.1.2.tar` & `pe-configurator-0.1.3.tar`
...
### Comparing `pe-configurator-0.1.2/PKG-INFO` & `pe-configurator-0.1.3/PKG-INFO`
...
### Comparing `pe-configurator-0.1.2/README.md` & `pe-configurator-0.1.3/README.md`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/data/calibration_files.txt` & `pe-configurator-0.1.3/data/calibration_files.txt`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/.DS_Store` & `pe-configurator-0.1.3/examples/.DS_Store`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190412/test.html` & `pe-configurator-0.1.3/examples/test_GW190412/test.html`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190412/test.json` & `pe-configurator-0.1.3/examples/test_GW190412/test.json`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190412/test.pdf` & `pe-configurator-0.1.3/examples/test_GW190412/test.pdf`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190521/test.html` & `pe-configurator-0.1.3/examples/test_GW190521/test.html`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190521/test.json` & `pe-configurator-0.1.3/examples/test_GW190521/test.json`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190521/test.pdf` & `pe-configurator-0.1.3/examples/test_GW190521/test.pdf`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190814/test.html` & `pe-configurator-0.1.3/examples/test_GW190814/test.html`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190814/test.json` & `pe-configurator-0.1.3/examples/test_GW190814/test.json`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW190814/test.pdf` & `pe-configurator-0.1.3/examples/test_GW190814/test.pdf`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW191109/test.html` & `pe-configurator-0.1.3/examples/test_GW191109/test.html`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW191109/test.json` & `pe-configurator-0.1.3/examples/test_GW191109/test.json`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/examples/test_GW191109/test.pdf` & `pe-configurator-0.1.3/examples/test_GW191109/test.pdf`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/pe_configurator.egg-info/PKG-INFO` & `pe-configurator-0.1.3/pe_configurator.egg-info/PKG-INFO`
...
### Comparing `pe-configurator-0.1.2/pe_configurator.egg-info/SOURCES.txt` & `pe-configurator-0.1.3/pe_configurator.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/peconfigurator/asimov.py` & `pe-configurator-0.1.3/peconfigurator/asimov.py`
...
### Comparing `pe-configurator-0.1.2/peconfigurator/auxiliary/make_report.py` & `pe-configurator-0.1.3/peconfigurator/auxiliary/make_report.py`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/peconfigurator/auxiliary/run_analyzer.py` & `pe-configurator-0.1.3/peconfigurator/auxiliary/run_analyzer.py`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/peconfigurator/get_settings.py` & `pe-configurator-0.1.3/peconfigurator/get_settings.py`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/peconfigurator/proc_samples.py` & `pe-configurator-0.1.3/peconfigurator/proc_samples.py`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/peconfigurator/run_on_many_events.py` & `pe-configurator-0.1.3/peconfigurator/run_on_many_events.py`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/pyproject.toml` & `pe-configurator-0.1.3/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pe-configurator-0.1.2/tests/test_get_settings.py` & `pe-configurator-0.1.3/tests/test_get_settings.py`
