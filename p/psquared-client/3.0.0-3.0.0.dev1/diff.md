# Comparing `tmp/psquared_client-3.0.0.tar.gz` & `tmp/psquared_client-3.0.0.dev1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "psquared_client-3.0.0.tar", last modified: Wed Apr 26 17:46:30 2023, max compression
+gzip compressed data, was "psquared_client-3.0.0.dev1.tar", last modified: Wed Feb 15 21:25:57 2023, max compression
```

## Comparing `psquared_client-3.0.0.tar` & `psquared_client-3.0.0.dev1.tar`

### file list

```diff
@@ -1,26 +1,23 @@
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.324468 psquared_client-3.0.0/
--rw-r--r--   0 patton     (502) staff       (20)      468 2023-04-26 17:46:30.324134 psquared_client-3.0.0/PKG-INFO
--rw-r--r--   0 patton     (502) staff       (20)     3262 2023-01-06 03:29:33.000000 psquared_client-3.0.0/README.md
--rw-r--r--   0 patton     (502) staff       (20)     1031 2023-04-26 17:46:24.000000 psquared_client-3.0.0/pyproject.toml
--rw-r--r--   0 patton     (502) staff       (20)       38 2023-04-26 17:46:30.324591 psquared_client-3.0.0/setup.cfg
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.311787 psquared_client-3.0.0/src/
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.311991 psquared_client-3.0.0/src/main/
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.312290 psquared_client-3.0.0/src/main/python/
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.312709 psquared_client-3.0.0/src/main/python/client_pkg/
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.319923 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/
--rw-r--r--   0 patton     (502) staff       (20)      268 2023-01-09 22:01:23.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/__init__.py
--rw-r--r--   0 patton     (502) staff       (20)     9822 2023-04-24 19:24:35.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/display.py
--rw-r--r--   0 patton     (502) staff       (20)    20885 2023-04-25 19:23:27.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/pp_cli.py
--rw-r--r--   0 patton     (502) staff       (20)    27124 2023-04-26 16:51:50.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/psquared.py
--rw-r--r--   0 patton     (502) staff       (20)    13963 2023-04-26 16:53:44.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/psquared_utils.py
--rw-r--r--   0 patton     (502) staff       (20)        0 2023-01-09 17:06:09.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/py.typed
--rw-r--r--   0 patton     (502) staff       (20)      264 2023-01-10 01:21:10.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/request_error.py
--rw-r--r--   0 patton     (502) staff       (20)      361 2023-01-10 01:21:29.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/response_error.py
--rw-r--r--   0 patton     (502) staff       (20)     3589 2023-04-11 01:37:27.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/utils.py
-drwxr-xr-x   0 patton     (502) staff       (20)        0 2023-04-26 17:46:30.323696 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/
--rw-r--r--   0 patton     (502) staff       (20)      468 2023-04-26 17:46:30.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/PKG-INFO
--rw-r--r--   0 patton     (502) staff       (20)      925 2023-04-26 17:46:30.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/SOURCES.txt
--rw-r--r--   0 patton     (502) staff       (20)        1 2023-04-26 17:46:30.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/dependency_links.txt
--rw-r--r--   0 patton     (502) staff       (20)       55 2023-04-26 17:46:30.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/entry_points.txt
--rw-r--r--   0 patton     (502) staff       (20)       14 2023-04-26 17:46:30.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/requires.txt
--rw-r--r--   0 patton     (502) staff       (20)       16 2023-04-26 17:46:30.000000 psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/top_level.txt
...
### Comparing `psquared_client-3.0.0/README.md` & `psquared_client-3.0.0.dev1/README.md`

 * *Files identical despite different names*

### Comparing `psquared_client-3.0.0/pyproject.toml` & `psquared_client-3.0.0.dev1/pyproject.toml`
...
### Comparing `psquared_client-3.0.0/src/main/python/client_pkg/psquared_client/psquared.py` & `psquared_client-3.0.0.dev1/src/main/python/client_pkg/psquared_client/psquared.py`
...
### Comparing `psquared_client-3.0.0/src/main/python/client_pkg/psquared_client.egg-info/SOURCES.txt` & `psquared_client-3.0.0.dev1/src/main/python/client_pkg/psquared_client.egg-info/SOURCES.txt`
