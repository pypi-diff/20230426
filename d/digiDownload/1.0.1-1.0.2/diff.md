# Comparing `tmp/digiDownload-1.0.1.tar.gz` & `tmp/digiDownload-1.0.2.tar.gz`
...
+gzip compressed data, was "digiDownload-1.0.2.tar", last modified: Wed Apr 26 17:12:37 2023, max compression
```

## Comparing `digiDownload-1.0.1.tar` & `digiDownload-1.0.2.tar`
...
+drwxr-xr-x   0 notyou    (1000) notyou    (1000)        0 2023-04-26 17:12:37.583611 digiDownload-1.0.2/
+-rw-r--r--   0 notyou    (1000) notyou    (1000)     1069 2023-04-20 11:45:13.000000 digiDownload-1.0.2/LICENSE
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      327 2023-04-26 17:12:37.583611 digiDownload-1.0.2/PKG-INFO
+-rw-r--r--   0 notyou    (1000) notyou    (1000)     1142 2023-04-26 14:37:11.000000 digiDownload-1.0.2/README.md
+drwxr-xr-x   0 notyou    (1000) notyou    (1000)        0 2023-04-26 17:12:37.583611 digiDownload-1.0.2/digiDownload/
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      194 2023-04-20 13:03:54.000000 digiDownload-1.0.2/digiDownload/AdBlockCookiePolicy.py
+-rw-r--r--   0 notyou    (1000) notyou    (1000)     5563 2023-04-26 17:08:41.000000 digiDownload-1.0.2/digiDownload/Book.py
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      800 2023-04-26 17:08:41.000000 digiDownload-1.0.2/digiDownload/LTIParser.py
+-rw-r--r--   0 notyou    (1000) notyou    (1000)     2120 2023-04-26 17:08:41.000000 digiDownload-1.0.2/digiDownload/Session.py
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      204 2023-04-26 17:08:41.000000 digiDownload-1.0.2/digiDownload/__init__.py
+-rw-r--r--   0 notyou    (1000) notyou    (1000)     1703 2023-04-26 17:08:41.000000 digiDownload-1.0.2/digiDownload/cli_tool.py
+-rw-r--r--   0 notyou    (1000) notyou    (1000)       85 2023-04-26 14:38:53.000000 digiDownload-1.0.2/digiDownload/exceptions.py
+drwxr-xr-x   0 notyou    (1000) notyou    (1000)        0 2023-04-26 17:12:37.583611 digiDownload-1.0.2/digiDownload.egg-info/
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      327 2023-04-26 17:12:37.000000 digiDownload-1.0.2/digiDownload.egg-info/PKG-INFO
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      399 2023-04-26 17:12:37.000000 digiDownload-1.0.2/digiDownload.egg-info/SOURCES.txt
+-rw-r--r--   0 notyou    (1000) notyou    (1000)        1 2023-04-26 17:12:37.000000 digiDownload-1.0.2/digiDownload.egg-info/dependency_links.txt
+-rw-r--r--   0 notyou    (1000) notyou    (1000)       49 2023-04-26 17:12:37.000000 digiDownload-1.0.2/digiDownload.egg-info/requires.txt
+-rw-r--r--   0 notyou    (1000) notyou    (1000)       13 2023-04-26 17:12:37.000000 digiDownload-1.0.2/digiDownload.egg-info/top_level.txt
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      102 2023-04-26 17:12:37.586944 digiDownload-1.0.2/setup.cfg
+-rw-r--r--   0 notyou    (1000) notyou    (1000)      555 2023-04-26 17:09:40.000000 digiDownload-1.0.2/setup.py
```

### Comparing `digiDownload-1.0.1/LICENSE` & `digiDownload-1.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `digiDownload-1.0.1/README.md` & `digiDownload-1.0.2/README.md`

 * *Files identical despite different names*

### Comparing `digiDownload-1.0.1/digiDownload/Book.py` & `digiDownload-1.0.2/digiDownload/Book.py`
...
### Comparing `digiDownload-1.0.1/digiDownload/LTIParser.py` & `digiDownload-1.0.2/digiDownload/LTIParser.py`
...
### Comparing `digiDownload-1.0.1/digiDownload/Session.py` & `digiDownload-1.0.2/digiDownload/Session.py`
...
### Comparing `digiDownload-1.0.1/digiDownload/cli_tool.py` & `digiDownload-1.0.2/digiDownload/cli_tool.py`
...
### Comparing `digiDownload-1.0.1/setup.py` & `digiDownload-1.0.2/setup.py`
