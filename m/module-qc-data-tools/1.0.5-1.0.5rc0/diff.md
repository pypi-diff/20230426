# Comparing `tmp/module_qc_data_tools-1.0.5.tar.gz` & `tmp/module_qc_data_tools-1.0.5rc0.tar.gz`

## Comparing `module_qc_data_tools-1.0.5.tar` & `module_qc_data_tools-1.0.5rc0.tar`

### file list

```diff
@@ -1,13 +1,13 @@
--rw-r--r--   0        0        0      153 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/.flake8
--rw-r--r--   0        0        0     1881 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/.gitlab-ci.yml
--rw-r--r--   0        0        0     3277 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/.pre-commit-config.yaml
--rw-r--r--   0        0        0      893 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/tbump.toml
--rw-r--r--   0        0        0      589 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/src/module_qc_data_tools/__init__.py
--rw-r--r--   0        0        0      160 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/src/module_qc_data_tools/_version.py
--rw-r--r--   0        0        0    13773 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/src/module_qc_data_tools/qcDataFrame.py
--rw-r--r--   0        0        0      116 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/tests/test_package.py
--rw-r--r--   0        0        0     2123 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/.gitignore
--rw-r--r--   0        0        0     1074 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/LICENSE
--rw-r--r--   0        0        0     2113 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/README.md
--rw-r--r--   0        0        0     2201 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/pyproject.toml
--rw-r--r--   0        0        0     4108 2020-02-02 00:00:00.000000 module_qc_data_tools-1.0.5/PKG-INFO
...
### Comparing `module_qc_data_tools-1.0.5/.gitlab-ci.yml` & `module_qc_data_tools-1.0.5rc0/.gitlab-ci.yml`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/.pre-commit-config.yaml` & `module_qc_data_tools-1.0.5rc0/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/tbump.toml` & `module_qc_data_tools-1.0.5rc0/tbump.toml`
...
-00000010: 7420 3d20 2231 2e30 2e35 220a 0a23 2045  t = "1.0.5"..# E
...
### Comparing `module_qc_data_tools-1.0.5/src/module_qc_data_tools/__init__.py` & `module_qc_data_tools-1.0.5rc0/src/module_qc_data_tools/__init__.py`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/src/module_qc_data_tools/qcDataFrame.py` & `module_qc_data_tools-1.0.5rc0/src/module_qc_data_tools/qcDataFrame.py`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/.gitignore` & `module_qc_data_tools-1.0.5rc0/.gitignore`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/LICENSE` & `module_qc_data_tools-1.0.5rc0/LICENSE`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/README.md` & `module_qc_data_tools-1.0.5rc0/README.md`

 * *Files 8% similar despite different names*

```diff
@@ -1,8 +1,8 @@
-# module QC data tools v1.0.5
...
-python -m pip install -U pip module-qc-data-tools==1.0.5
...
### Comparing `module_qc_data_tools-1.0.5/pyproject.toml` & `module_qc_data_tools-1.0.5rc0/pyproject.toml`

 * *Files identical despite different names*

### Comparing `module_qc_data_tools-1.0.5/PKG-INFO` & `module_qc_data_tools-1.0.5rc0/PKG-INFO`
