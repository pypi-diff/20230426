# Comparing `tmp/LiSE-0.14.1.tar.gz` & `tmp/LiSE-0.9.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "LiSE-0.14.1.tar", last modified: Wed Apr 26 20:57:58 2023, max compression
+gzip compressed data, was "dist/LiSE-0.9.1.tar", last modified: Tue Oct 30 13:40:31 2018, max compression
```

## Comparing `LiSE-0.14.1.tar` & `LiSE-0.9.1.tar`

### file list

```diff
@@ -1,67 +1,40 @@
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.692667 LiSE-0.14.1/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    34523 2023-02-01 14:04:01.000000 LiSE-0.14.1/LICENSE
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.684666 LiSE-0.14.1/LiSE/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)      750 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/__init__.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    16541 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/alchemy.py
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.688666 LiSE-0.14.1/LiSE/allegedb/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    78586 2023-04-26 20:56:14.000000 LiSE-0.14.1/LiSE/allegedb/__init__.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    14947 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/allegedb/alchemy.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    46612 2023-04-08 02:47:11.000000 LiSE-0.14.1/LiSE/allegedb/cache.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    31321 2023-03-25 04:26:29.000000 LiSE-0.14.1/LiSE/allegedb/graph.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    25892 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/allegedb/query.py
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.688666 LiSE-0.14.1/LiSE/allegedb/tests/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)        0 2021-07-09 20:18:57.000000 LiSE-0.14.1/LiSE/allegedb/tests/__init__.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)      318 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/allegedb/tests/conftest.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    12217 2023-04-06 16:58:07.000000 LiSE-0.14.1/LiSE/allegedb/tests/test_all.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     3424 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/allegedb/tests/test_branch_plan.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     7498 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/allegedb/tests/test_load.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     4594 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/allegedb/tests/test_window.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    20686 2023-04-05 02:07:38.000000 LiSE-0.14.1/LiSE/allegedb/window.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     8504 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/allegedb/wrap.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    26142 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/cache.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    48041 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/character.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    56126 2023-04-26 20:56:14.000000 LiSE-0.14.1/LiSE/engine.py
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.688666 LiSE-0.14.1/LiSE/examples/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)      722 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/examples/__init__.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     7592 2023-03-29 12:48:53.000000 LiSE-0.14.1/LiSE/examples/college.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     6036 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/examples/kobold.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     4294 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/examples/polygons.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     5985 2023-04-08 02:47:28.000000 LiSE-0.14.1/LiSE/examples/sickle.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     4268 2023-04-05 03:51:56.000000 LiSE-0.14.1/LiSE/examples/wolfsheep.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     3493 2023-03-12 00:22:48.000000 LiSE-0.14.1/LiSE/exc.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    44184 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/handle.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    20966 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/node.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     6404 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/portal.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    72217 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/proxy.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    47789 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/query.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    20947 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/rule.py
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.688666 LiSE-0.14.1/LiSE/server/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     3139 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/server/__init__.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     1700 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/server/__main__.py
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.692667 LiSE-0.14.1/LiSE/tests/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)      722 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/tests/__init__.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     1041 2023-04-05 03:52:31.000000 LiSE-0.14.1/LiSE/tests/conftest.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    18167 2023-03-19 01:50:32.000000 LiSE-0.14.1/LiSE/tests/data.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     7709 2023-03-25 11:49:17.000000 LiSE-0.14.1/LiSE/tests/test_character.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     3445 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/tests/test_contents.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     1806 2023-04-08 01:10:03.000000 LiSE-0.14.1/LiSE/tests/test_examples.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     3620 2023-04-05 01:17:14.000000 LiSE-0.14.1/LiSE/tests/test_load.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     5127 2023-03-19 17:35:16.000000 LiSE-0.14.1/LiSE/tests/test_next_turn.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     3179 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/tests/test_place.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     4300 2023-02-12 18:19:27.000000 LiSE-0.14.1/LiSE/tests/test_proxy.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    12808 2023-04-22 15:41:11.000000 LiSE-0.14.1/LiSE/tests/test_query.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)      477 2023-04-05 01:17:14.000000 LiSE-0.14.1/LiSE/tests/test_resume.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     4641 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/tests/test_rule.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     2493 2022-09-07 08:44:17.000000 LiSE-0.14.1/LiSE/tests/test_thing.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    24956 2023-04-26 20:55:29.000000 LiSE-0.14.1/LiSE/util.py
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    12668 2023-04-16 05:58:38.000000 LiSE-0.14.1/LiSE/xcollections.py
-drwxrwxr-x   0 sanotehu  (1000) sanotehu  (1000)        0 2023-04-26 20:57:58.684666 LiSE-0.14.1/LiSE.egg-info/
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    56484 2023-04-26 20:57:58.000000 LiSE-0.14.1/LiSE.egg-info/PKG-INFO
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     1304 2023-04-26 20:57:58.000000 LiSE-0.14.1/LiSE.egg-info/SOURCES.txt
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)        1 2023-04-26 20:57:58.000000 LiSE-0.14.1/LiSE.egg-info/dependency_links.txt
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)      191 2023-04-26 20:57:58.000000 LiSE-0.14.1/LiSE.egg-info/requires.txt
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)        5 2023-04-26 20:57:58.000000 LiSE-0.14.1/LiSE.egg-info/top_level.txt
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    56484 2023-04-26 20:57:58.692667 LiSE-0.14.1/PKG-INFO
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)    15976 2023-04-26 20:55:29.000000 LiSE-0.14.1/README.md
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)     1153 2023-04-26 20:57:00.000000 LiSE-0.14.1/pyproject.toml
--rw-rw-r--   0 sanotehu  (1000) sanotehu  (1000)       38 2023-04-26 20:57:58.692667 LiSE-0.14.1/setup.cfg
...
### Comparing `LiSE-0.14.1/LiSE/__init__.py` & `LiSE-0.9.1/LiSE/__init__.py`
...
### Comparing `LiSE-0.14.1/LiSE/examples/__init__.py` & `LiSE-0.9.1/LiSE/examples/__init__.py`
...
### Comparing `LiSE-0.14.1/LiSE/examples/college.py` & `LiSE-0.9.1/LiSE/examples/college.py`
...
### Comparing `LiSE-0.14.1/LiSE/exc.py` & `LiSE-0.9.1/LiSE/exc.py`
...
### Comparing `LiSE-0.14.1/LiSE/server/__main__.py` & `LiSE-0.9.1/LiSE/server/__main__.py`
